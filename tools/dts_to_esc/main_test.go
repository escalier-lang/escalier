...
func TestRun_BootstrapWithCFGPrintsEveryReport(t *testing.T) {
  ...
  receivers: 194 confirmed by a name tier, 2 heuristics corrected, 0 redundant overrides, 0 disagreements, 70 answered by the facts alone, 37 overrides no fact answers
