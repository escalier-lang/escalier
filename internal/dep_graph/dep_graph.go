...
func extractTypeParamRefs(typeAnn ast.TypeAnn, availableTypeParams map[string]bool) []string {
	if typeAnn == nil {
		return nil
	}
...
func (v *typeParamRefVisitor) EnterTypeAnn(typeAnn ast.TypeAnn) bool {
...
func (v *DependencyVisitor) processTypeParams(typeParams []*ast.TypeParam) {
	...
	sortedTypeParams := sortTypeParamsTopologically(typeParams)
