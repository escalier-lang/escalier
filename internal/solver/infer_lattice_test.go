...
func TestInferUnionAnnotationRejectsNonMember(t *testing.T) {
	...
	require.Equal(t, "3:29-3:30: cannot constrain boolean <: number | string", msgWithSpan(t, errs[0]))
}
...
func TestInferIntersectionAnnotationRejectsMissingMember(t *testing.T) {
	...
	require.Equal(t, "1:31-1:37: object is missing property: y", msgWithSpan(t, errs[0]))
}
...
func TestInferUnionAnnotationDedups(t *testing.T) {
	...
	require.Equal(t, []string(nil), messagesWithSpan(t, errs))
