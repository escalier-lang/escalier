...
// It names `generate` even on the write paths `bootstrap` and
// `regenerate` take, because those produce the same artifact and #1345
// removes both; a banner that varied by subcommand would make the
// committed tree depend on which one wrote it.
