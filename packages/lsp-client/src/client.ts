...
export class Client {
    ...
    async initialize(params: lsp.InitializeParams): AsyncResult<lsp.InitializeResult, Error> {
        try { 
    ...
    async didOpen(params: lsp.DidOpenTextDocumentParams): AsyncResult<void, Error> {
        try {
    ...
    async didChange(params: lsp.DidChangeTextDocumentParams): AsyncResult<void, Error> {
        try {
    ...
    onPublishDiagnostics(callback: (params: lsp.PublishDiagnosticsParams) => void) {
