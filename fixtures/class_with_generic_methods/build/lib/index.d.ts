...
declare const Foo: {new (value: number): Foo, addNums1(a: number, b: number): number, addStrs3<A extends string, B extends string>(a: A, b: B): number, addNums4<A extends number, B extends number>(a: A, b: B): number};
