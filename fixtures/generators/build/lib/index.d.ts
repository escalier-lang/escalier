...
export declare function genCount(): Generator<10 | 20, void, never>;
export declare const genExpr: () => Generator<"a", void, never>;
export declare function genFetch(): AsyncGenerator<1, void, never>;
export declare function genNoYield(): Generator<never, 1, never>;
